...
usr/local/bin/docker-compose &>> /DNIF/install.log
                ...
                sudo curl -L "https://github.com/docker/compose/releases/download/1.23.1/docker-compose-$(uname -s)-$(uname -m)" -o /usr/loca
l/bin/docker-compose &>> /DNIF/install.log
                sudo chmod +x /usr/local/bin/docker-compose&>> /DNIF/install.log
                echo -e "[-] Installing docker-compose - ... \e[1;32m[DONE] \e[0m\n"
        fi
